...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Commissioner:wght@100..900&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet">
...
<body>    
    <section class="bgblack welcome-page">
        <header class="full-screen"><!-- fullscrean for making menu -->
            ...
            <div class="header-logo"><a href="#top"><img  src="assets/img/logo-circle-white.svg" alt="Logotype"></a></div>
            <button class="header-toggle"><img  src="assets/img/mobile/menu-toggle.svg" alt="menu"></button>
        ...
        <div>
            <div class="welcome-mobile welcome-title-animation"><img class="welcome-title-animation-target" src="assets/img/mobile/welcome.svg" alt="Welcome to Armstrong Werth"></div>
            <div class="welcome-desctop">
                <div class="welcome-title-animation"><img class="welcome-title-animation-target" src="assets/img/desctop/welcome.svg" alt="welcome to"></div>
                <div class="welcome-title-animation"><img class="welcome-title-animation-target" src="assets/img/desctop/armstrong.svg" alt="armstrong"></div>
                <div class="welcome-title-animation"><img class="welcome-title-animation-target" src="assets/img/desctop/werth.svg" alt="werth"></div>
            </div>
        </div>
        <div class="welcome-photo">
            <img class="welcome-photo-animation" src="assets/img/welcome-photo.png" alt="oboes" >
        </div>
    ...
    <div id="modal-container" class="modal-white"><!-- two oposit condition modal-black/modal-white --> 
        <button class="modal-cross"><img src="assets/img/cross.svg" alt="X"></button>

        <div style="position: relative; height: max-content;">
            <div id="regal-oboe" class="instrument-card">
                <div class="instrument-photos">
                    <img src="assets/img/instruments/regal/regal_1.jpg" alt="Regal Oboe">
                    <img src="assets/img/instruments/regal/regal_2.jpg" alt="Regal Oboe">
                    <img src="assets/img/instruments/regal/regal_3.jpg" alt="Regal Oboe">
                    <img src="assets/img/instruments/regal/regal_4.jpg" alt="Regal Oboe">
                    <img src="assets/img/instruments/regal/regal_5.jpg" alt="Regal Oboe">
                    <div class="photo-pagination">
                        <button class="paginator-left">
            ...
            <div id="imperial-oboe" class="instrument-card">
                <div class="instrument-photos">
                    <img src="assets/img/instruments/imperial/imperial_1.jpg" alt="Imperial Oboe">
                    <img src="assets/img/instruments/imperial/imperial_2.jpg" alt="Imperial Oboe">
                    <img src="assets/img/instruments/imperial/imperial_3.jpg" alt="Imperial Oboe">
                    <img src="assets/img/instruments/imperial/imperial_4.jpg" alt="Imperial Oboe">
                    <div class="photo-pagination">
                        <button class="paginator-left">
                            <svg alt="left arrow" data-arrow="true" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 6.58423L3.59264 6.58423C4.08586 6.29925 4.54005 5.94683 4.94226 5.53587C5.52542 4.94001 5.98789 4.23275 6.30339 3.45451C6.61887 2.67627 6.78123 1.84224 6.78123 0.999999L6.78123 0.899999L6.68123 0.899999L6.06311 0.899999L5.96311 0.899999L5.96311 0.999999C5.96311 1.73362 5.82168 2.46001 5.54697 3.13768C5.27225 3.81534 4.86964 4.43094 4.36224 4.94938C3.85484 5.46782 3.25259 5.87896 2.58993 6.15941C1.92728 6.43987 1.21712 6.58419 0.500001 6.58419L0.4 6.58419L0.4 6.68419L0.4 7.31576L0.4 7.41576L0.5 7.41576C1.21712 7.41576 1.92727 7.56013 2.58993 7.84058C3.25259 8.12104 3.85484 8.53217 4.36224 9.05062C4.86964 9.56906 5.27225 10.1847 5.54696 10.8623C5.82168 11.54 5.9631 12.2664 5.9631 13L5.9631 13.1L6.0631 13.1L6.68123 13.1L6.78123 13.1L6.78123 13C6.78123 12.1578 6.61887 11.3237 6.30338 10.5455C5.98789 9.76725 5.52542 9.05999 4.94226 8.46413C4.54006 8.05318 4.08589 7.70078 3.59269 7.4158L17.5 7.4158L17.6 7.4158L17.6 7.3158L17.6 6.68423L17.6 6.58423L17.5 6.58423Z" stroke-width="0.2"/>
            ...
            <div id="pan-oboe" class="instrument-card">
                <div class="instrument-photos">
                    <img src="assets/img/instruments/pan/pan_1.jpg" alt="Pan Oboe">
                    <img src="assets/img/instruments/pan/pan_2.jpg" alt="Pan Oboe">
                    <div class="photo-pagination">
                        <button class="paginator-left">
                            <svg alt="left arrow" data-arrow="true" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 6.58423L3.59264 6.58423C4.08586 6.29925 4.54005 5.94683 4.94226 5.53587C5.52542 4.94001 5.98789 4.23275 6.30339 3.45451C6.61887 2.67627 6.78123 1.84224 6.78123 0.999999L6.78123 0.899999L6.68123 0.899999L6.06311 0.899999L5.96311 0.899999L5.96311 0.999999C5.96311 1.73362 5.82168 2.46001 5.54697 3.13768C5.27225 3.81534 4.86964 4.43094 4.36224 4.94938C3.85484 5.46782 3.25259 5.87896 2.58993 6.15941C1.92728 6.43987 1.21712 6.58419 0.500001 6.58419L0.4 6.58419L0.4 6.68419L0.4 7.31576L0.4 7.41576L0.5 7.41576C1.21712 7.41576 1.92727 7.56013 2.58993 7.84058C3.25259 8.12104 3.85484 8.53217 4.36224 9.05062C4.86964 9.56906 5.27225 10.1847 5.54696 10.8623C5.82168 11.54 5.9631 12.2664 5.9631 13L5.9631 13.1L6.0631 13.1L6.68123 13.1L6.78123 13.1L6.78123 13C6.78123 12.1578 6.61887 11.3237 6.30338 10.5455C5.98789 9.76725 5.52542 9.05999 4.94226 8.46413C4.54006 8.05318 4.08589 7.70078 3.59269 7.4158L17.5 7.4158L17.6 7.4158L17.6 7.3158L17.6 6.68423L17.6 6.58423L17.5 6.58423Z" stroke-width="0.2"/>
            ...
            <div id="rocket-oboe" class="instrument-card">
                <div class="instrument-photos">
                    <img src="assets/img/instruments/rocket/rocket_1.jpg" alt="Rocket Oboe">
                    <img src="assets/img/instruments/rocket/rocket_2.jpg" alt="Rocket Oboe">
                    <div class="photo-pagination">
                        <button class="paginator-left">
                            <svg alt="left arrow" data-arrow="true" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 6.58423L3.59264 6.58423C4.08586 6.29925 4.54005 5.94683 4.94226 5.53587C5.52542 4.94001 5.98789 4.23275 6.30339 3.45451C6.61887 2.67627 6.78123 1.84224 6.78123 0.999999L6.78123 0.899999L6.68123 0.899999L6.06311 0.899999L5.96311 0.899999L5.96311 0.999999C5.96311 1.73362 5.82168 2.46001 5.54697 3.13768C5.27225 3.81534 4.86964 4.43094 4.36224 4.94938C3.85484 5.46782 3.25259 5.87896 2.58993 6.15941C1.92728 6.43987 1.21712 6.58419 0.500001 6.58419L0.4 6.58419L0.4 6.68419L0.4 7.31576L0.4 7.41576L0.5 7.41576C1.21712 7.41576 1.92727 7.56013 2.58993 7.84058C3.25259 8.12104 3.85484 8.53217 4.36224 9.05062C4.86964 9.56906 5.27225 10.1847 5.54696 10.8623C5.82168 11.54 5.9631 12.2664 5.9631 13L5.9631 13.1L6.0631 13.1L6.68123 13.1L6.78123 13.1L6.78123 13C6.78123 12.1578 6.61887 11.3237 6.30338 10.5455C5.98789 9.76725 5.52542 9.05999 4.94226 8.46413C4.54006 8.05318 4.08589 7.70078 3.59269 7.4158L17.5 7.4158L17.6 7.4158L17.6 7.3158L17.6 6.68423L17.6 6.58423L17.5 6.58423Z" stroke-width="0.2"/>
            ...
            <div id="english-horn" class="instrument-card">
                <div class="instrument-photos">
                    <img src="assets/img/instruments/horn/eh_1.jpg" alt="English Horn">
                    <img src="assets/img/instruments/horn/eh_2.jpg" alt="English Horn">
                    <img src="assets/img/instruments/horn/eh_3.jpg" alt="English Horn">
                    <img src="assets/img/instruments/horn/eh_4.jpg" alt="English Horn">
                    <img src="assets/img/instruments/horn/eh_5.jpg" alt="English Horn">
                    <div class="photo-pagination">
                        <button class="paginator-left">
                            <svg alt="left arrow" data-arrow="true" viewBox="0 0 18 14" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 6.58423L3.59264 6.58423C4.08586 6.29925 4.54005 5.94683 4.94226 5.53587C5.52542 4.94001 5.98789 4.23275 6.30339 3.45451C6.61887 2.67627 6.78123 1.84224 6.78123 0.999999L6.78123 0.899999L6.68123 0.899999L6.06311 0.899999L5.96311 0.899999L5.96311 0.999999C5.96311 1.73362 5.82168 2.46001 5.54697 3.13768C5.27225 3.81534 4.86964 4.43094 4.36224 4.94938C3.85484 5.46782 3.25259 5.87896 2.58993 6.15941C1.92728 6.43987 1.21712 6.58419 0.500001 6.58419L0.4 6.58419L0.4 6.68419L0.4 7.31576L0.4 7.41576L0.5 7.41576C1.21712 7.41576 1.92727 7.56013 2.58993 7.84058C3.25259 8.12104 3.85484 8.53217 4.36224 9.05062C4.86964 9.56906 5.27225 10.1847 5.54696 10.8623C5.82168 11.54 5.9631 12.2664 5.9631 13L5.9631 13.1L6.0631 13.1L6.68123 13.1L6.78123 13.1L6.78123 13C6.78123 12.1578 6.61887 11.3237 6.30338 10.5455C5.98789 9.76725 5.52542 9.05999 4.94226 8.46413C4.54006 8.05318 4.08589 7.70078 3.59269 7.4158L17.5 7.4158L17.6 7.4158L17.6 7.3158L17.6 6.68423L17.6 6.58423L17.5 6.58423Z" stroke-width="0.2"/>
            ...
            <div class="instrument-nav">
                <button class="instrument-arrow previous-card">
    ...
    <div id="data-sent">
        <div><img src="assets/img/data-sent.svg" alt=""></div>
    ...
    <main>
        <section id="about">
            <div class="main-overlay-trigger">
                <div class="about-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/about.svg" alt="Enjoy the classic"></div>
                <div class="about-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/about.svg" alt="Enjoy the classic"></div>
            </div>
        ...
        <section id="products">
            <div class="newspaper-style">
                <div class="products-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/products.svg" alt="Discover Our Products"></div>
                <div class="products-desctop title-animation-body"><img class="title-animation-target" src="assets/img/mobile/products.svg" alt="Discover Our Products"></div>
            </div>            
            <div class="newspaper-style">
            ...
            <div class="catalog-template-big">
                <div class="catalog-main-photo">
                    <div><img src="assets/img/lorem-ipsum.jpeg" alt=""></div>
                </div>
                <div class="bordered-list catalog-template">
                    <div class="catalog-card">
                        ...
                        <div  class="photo-holder">
                            <div><img src="assets/img/instruments/regal/regal_1.jpg" alt="regal oboe image"></div>
                        </div>
                        <div><button onclick="openModal('regal-oboe')" class="catalog-button">learn more</button></div>
                        <!-- <img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"> -->
                    </div>
                    <div class="catalog-card">
                        <div>
                        ...
                        <div class="photo-holder"><img src="assets/img/instruments/imperial/imperial_1.jpg" alt="imperial oboe image"></div>
                    ...
                    <div class="catalog-card">
                        ...
                        <div class="photo-holder"><img src="assets/img/instruments/pan/pan_1.jpg" alt="pan oboe image"></div>
                    ...
                    <div class="catalog-card">
                        ...
                        <div class="photo-holder"><img src="assets/img/instruments/rocket/rocket_2.jpg" alt="rocket oboe image"></div>
                    ...
                    <div class="catalog-card">
                        ...
                        <div class="photo-holder"><img src="assets/img/instruments/horn/eh_1.jpg" alt="horn image"></div>
        ...
        <section class="newspaper-style process">
            <div class="process-photo">
                <div><img class="process-photo-position" src="assets/img/process-photo.png" alt="photo of process"></div>
            </div>
            <div class="center-content process-title">
                <div class="process-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/process.svg" alt="The Art of Instrument Production"></div>
                <div class="process-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/process.svg" alt="The Art of Instrument Production"></div>
            </div>              
        ...
        <section class="harmonic-beayty">
            <div>
                <div class="explore-beauty-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/explore-beauty.svg" alt="Explore Harmonic Beauty"></div>
                <div class="explore-beauty-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/explore-beauty.svg" alt="Explore Harmonic Beauty"></div>
            </div>
            <div>
        ...
        <section id="partners">             
            <div class="newspaper-style">
                <div class="retailers-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/retailers.svg" alt="Explore Authorized Retailers"></div>
                <div class="retailers-desctop title-animation-body"><img class="title-animation-target" src="assets/img/mobile/retailers.svg" alt="Explore Authorized Retailers"></div>
            </div>
            <div class="newspaper-style">
            ...
            <!-- <div class="founder-overlay">
                <svg class="founder-overlay-svg" xmlns="http://www.w3.org/2000/svg"  width="100%" height="100%" >
                    <path></path>
                    
                    <rect x="0" y="100" width="100%" height="10" fill="red"/>
                    <path d="M 0 850 H100% V 950 H0 Z" fill="red"/>
                </svg>
            </div> -->
            <div class="retailers">
                <div class="retailers-card">
                    <div class="retailers-image"><img src="assets/img/retailers/zasmusic.jpg" alt="zasmusuc"></div>
                    <div class="retailers-infobar">
                        <div>
                            <div class="retailers-name">Zasmusic</div>
                            <div class="retailers-country">Spain</div>
                        </div>
                        <button onclick="redirectToLink(0)"><img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"></button>
                    </div>
                </div>                
                <div class="retailers-card">
                    <div class="retailers-image"><img src="assets/img/retailers/aj-music.png" alt="aj-music"></div>
                    <div class="retailers-infobar">
                        <div>
                            <div class="retailers-name">A.J.Musique</div>
                            <div class="retailers-country">France</div>
                        </div>
                        <button onclick="redirectToLink(1)"><img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"></button>
                    </div>
                </div>                
                <div class="retailers-card">
                    <div class="retailers-image">
                        <!-- <img src="way/to/retailers/img" alt="zasmusuc" data-arrow="true"> -->
                    </div>
                    <div class="retailers-infobar">
                        <div>
                        ...
                        <button onclick="redirectToLink(2)"><img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"></button>
                    </div>
                </div>                
                <div class="retailers-card">
                    <div class="retailers-image"><img src="assets/img/retailers/oboe-central.png" alt="oboe central"></div>
                    <div class="retailers-infobar">
                        <div>
                            <div class="retailers-name">Oboe Central</div>
                            <div class="retailers-country">Australia</div>
                        </div>
                        <button onclick="redirectToLink(3)"><img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"></button>
                    </div>
                </div>                
                <div class="retailers-card">
                    <div class="retailers-image"><img src="assets/img/retailers/sax-and-woodwind.png" alt="Sax and Woodwind"></div>
                    <div class="retailers-infobar">
                        <div>
                            <div class="retailers-name">Sax and Woodwind</div>
                            <div class="retailers-country">Australia</div>
                        </div>
                        <button onclick="redirectToLink(4)"><img class="right-arrows" src="assets/img/arrow.svg" alt="->" data-arrow="true"></button>
                    </div>
                </div>                
            </div>
        </section>
        ...
        <section class="bgblack" id="founder">        
            <div class="founder-bio">
                <div class="founder-title">
                    <div class="founder-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/founder.svg" alt="A Legacy Built on Passion"></div>
                    <div class="founder-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/founder.svg" alt="A Legacy Built on Passion"></div>
                </div>
                <div class="founder-photo-rectangle"><img class="founder-rectangle-animation" src="assets/img/founder-rectangle.png" alt="Jhon's photo"></div>
                <div>
            ...
            <div class="founder-chronology">
                ...
                <div class="bio-facts">
                    <div class="timeline-fact" data-activity="activ">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/1980.png" alt="1980"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/1989.jpeg" alt="1989"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/2003.png" alt="2003"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/2006.jpeg" alt="2006"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/2008.jpeg" alt="2008"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/2012.png" alt="2012"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/2020.png" alt="2020"></div>
                    </div>
                    <div class="timeline-fact" data-activity="">
                        ...
                        <div class="bio-facts-photo"><img src="assets/img/timeline/now.jpeg" alt="Present"></div>
                    </div>
                </div>
                </div>
            </div>
            <div style="position: relative;">                
                <div class="quote-photo"><img src="assets/img/founder-cercle.png" alt="photo of Jhon"></div>                
                <div class="quote">
        ...
        <section class="section-faq">
            <div>
                <div class="faq-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/faq.svg" alt="Your Queries Answered"></div>
                <div class="faq-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/faq.svg" alt=""></div>
            </div>
            <div>
            ...
            <div>
                <dl class="bordered-list faq-template">
                    <div class="faq-placeholder">
                        ...
                        <div class="cross"><img src="assets/img/cross.svg" alt="+"></div>
                    </div>
                    <div class="faq-placeholder">
                        <div>
                    ...
                    <div class="faq-placeholder" style="display: none">
                        <div>
                            <dt>Are there any additional accessories or features included with the instrument, such as a case or cleaning
                                kit? </dt>
                            <dd class="answer">A: Your AW oboe comes with a little entourage! Picture this - a cozy case and its stylish cover, a comfy
                                reed box, a
                                trusty pull-through, and a polishing cloth for that extra shine. It's like your oboe has its own squad,
                                ready to
                                keep it in tip-top shape!</dd>
                        </div>
                        <div class="cross"><img src="assets/img/cross.svg" alt="+"></div>
                    </div>
                </dl>
            </div>
            <button class="faq-button">learn more</button>            
        </section>

        <section class="bgblack feedback-section">            
            <div class="center-content feedback-content">
                <div class="melodic-journey-f-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/first-melodic-journey.svg" alt="Start Your Melodic Journey Today!"></div>
                <div class="melodic-journey-s-mobile title-animation-body"><img class="title-animation-target" src="assets/img/mobile/second-melodic-journey.svg" alt="Start Your Melodic Journey Today!"></div>
                <div class="melodic-journey-f-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/first-melodic-journey.svg" alt="Start Your Melodic Journey Today!"></div>
                <div class="melodic-journey-s-desctop title-animation-body"><img class="title-animation-target" src="assets/img/desctop/second-melodic-journey.svg" alt="Start Your Melodic Journey Today!"></div>
            </div>
            <div class="feedback-text">
                <p>We believe in nurturing strong partnerships with like-minded individuals who share our love for music. Whether you
                    are
                    an instrument seller or a passionate musician looking to collaborate, we welcome you to join our community of
                    partners.
                </p>
            </div>
            <div>
                <form class="feedback-form" method="POST">
                    ...
                    <div class="checkbox">
                        ...
                        <label for="consentCheckbox"><a href="privaci-policy.html">I agree with the privacy policy</a></label>
                    </div>
                </form>
            </div>
        </section>
    ...
    <footer>
        <div class="footer-logo"><a href="#top"><img src="assets/img/footer-logo.svg" alt="logotype"></a></div>
        <div class="footer-name">
            <div class="footer-name-mobile"><img src="assets/img/mobile/footer-name.svg" alt="armstrong werth"></div>
            <div class="footer-name-desctop"><img src="assets/img/mobile/footer-name.svg" alt="armstrong werth"></div>
        </div>
        <div class="footer-menu">
            <div><a class="menu-target-link" href="#about">about us</a></div>
            <div><a class="menu-target-link" href="#products">instruments</a></div>
            <div><a class="menu-target-link" href="#partners">retailers</a></div>
            <div><a class="menu-target-link" href="#contacts">contacts</a></div>
        </div>
        <div class="footer-contacts">
            <dl id="contacts">
                <div>
                    <td>E-mail</td>
                    <dd><a href="mailto:example@autlook.com">example@autlook.com</a></dd>
                </div>
                <div>
                    <td>Tel</td>
                    <dd><a href="tel:+12345678910">+123 45 67-89-10</a></dd>
                </div>
                <div>
                    <td>Community</td>
                    <div class="social-media">
                        <dd><a href="">Instagramm</a></dd>
    ...
    <div class="underfooter">
        <a href="https://t.me/Ministrely">designer</a>
        <a href="privaci-policy.html">privacy policy</a>
        <a href="https://t.me/DarkVib">programmer</a>
    </div>    
